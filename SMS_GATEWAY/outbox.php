                    ...
                    <div class="col-md-12 panel-warning">
                        <div class="content-box-header panel-heading">
                            ...
                            <div class="panel-options">
                               ...
                               <a href="delete.php?id_truncate_outbox" onclick="return confirm('Apakah anda yakin ingin menghapus SEMUA data pesan terkirim?')"><i class="glyphicon glyphicon-trash" title="reset data"></i></a>
                            </div>
                        </div>
